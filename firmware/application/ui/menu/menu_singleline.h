...
#define MENU_SINGLELINE_SETTING_IDX_COLD_OIL_DISPLAY 15
#define MENU_SINGLELINE_SETTING_IDX_LOW_VOLT_WARNING 16
#define MENU_SINGLELINE_SETTING_IDX_ABOUT 17
#define MENU_SINGLELINE_SETTING_IDX_PAIRINGS 18
